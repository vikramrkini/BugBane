...
class PageElement(object):
    ...
    def replace_with(self, *args):
        ...
        if len(args) == 1 and args[0] is self:
            return
        if not any((x is self.parent for x in args)):
    ...
    def _find_all(self, name, attrs, string, limit, generator, **kwargs):
        ...
        if string is None and 'text' in kwargs:
            ...
            warnings.warn("The 'text' argument to find()-type methods is deprecated. Use 'string' instead.", DeprecationWarning, stacklevel=_stacklevel)
...
class Tag(PageElement):
    ...
    def __init__(self, parser=None, builder=None, name=None, namespace=None, prefix=None, attrs=None, parent=None, previous=None, is_xml=None, sourceline=None, sourcepos=None, can_be_empty_element=None, cdata_list_attributes=None, preserve_whitespace_tags=None, interesting_string_types=None, namespaces=None):
        """Basic constructor.
    ...
    def __copy__(self):
        ...
        """
        clone = type(self)(None, self.builder, self.name, self.namespace, self.prefix, self.attrs, is_xml=self._is_xml, sourceline=self.sourceline, sourcepos=self.sourcepos, can_be_empty_element=self.can_be_empty_element, cdata_list_attributes=self.cdata_list_attributes, preserve_whitespace_tags=self.preserve_whitespace_tags, interesting_string_types=self.interesting_string_types)
    ...
    def smooth(self):
        ...
        for (i, a) in enumerate(self.contents):
            ...
            if i == len(self.contents) - 1:
                continue
            b = self.contents[i + 1]
            if isinstance(a, NavigableString) and isinstance(b, NavigableString) and (not isinstance(a, PreformattedString)) and (not isinstance(b, PreformattedString)):
                marked.append(i)
    ...
    def __getattr__(self, tag):
        ...
        if len(tag) > 3 and tag.endswith('Tag'):
            tag_name = tag[:-3]
            warnings.warn('.%(name)sTag is deprecated, use .find("%(name)s") instead. If you really were looking for a tag called %(name)sTag, use .find("%(name)sTag")' % dict(name=tag_name), DeprecationWarning, stacklevel=2)
    ...
    def search(self, markup):
        ...
        if hasattr(markup, '__iter__') and (not isinstance(markup, (Tag, str))):
            for element in markup:
                if not (isinstance(element, NavigableString) and self.search(element)):
                    found = element
                    break
